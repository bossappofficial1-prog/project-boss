...
<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div class="max-w-7xl mx-auto">
        ...
        <div class="text-center mb-16">
          ...
          <p class="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            {{ searchQuery ? `Menampilkan hasil pencarian untuk "${searchQuery}"` : 'Outlet pilihan terbaik yang telah terpercaya dan berkualitas tinggi' }}
          </p>
        </div>
        ...
        <div v-if="pending" class="flex justify-center py-20">
          <div class="text-center">
            <div class="relative mb-8">
              <div class="w-20 h-20 bg-gradient-to-r from-red-500 to-red-600 rounded-full flex items-center justify-center animate-pulse">
        ...
        <div v-else-if="!outlets.length" class="text-center py-20">
          ...
          <p class="text-gray-600 dark:text-gray-400 mb-8 max-w-md mx-auto">
            {{ searchQuery ? 'Coba gunakan kata kunci yang berbeda atau lebih spesifik untuk hasil yang lebih baik.' : 'Saat ini belum ada outlet yang terdaftar. Silakan coba lagi nanti!' }}
          </p>
          <button v-if="searchQuery" @click="clearSearch" 
            class="bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
            <div v-for="outlet in outlets" :key="outlet.id" 
              ...
              <NuxtLink :to="`/outlets/${outlet.id}`">
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100 dark:border-gray-700 hover:border-red-200 dark:hover:border-red-600 transform hover:-translate-y-2">
                  <!-- Image Section -->
                  ...
                  <!-- Content Section -->
                  <div class="p-6">
                    <h3 class="font-bold text-xl text-gray-900 dark:text-white mb-3 group-hover:text-red-600 dark:group-hover:text-red-400 transition-colors duration-300 line-clamp-2">
                    ...
                    <div class="flex items-center justify-between pt-6 border-t border-gray-100 dark:border-gray-700">
                      ...
                      <div class="flex items-center text-red-600 dark:text-red-400 font-bold group-hover:text-red-700 dark:group-hover:text-red-300 transition-colors duration-300">
                        <span class="mr-2">Lihat Detail</span>
                        <Icon name="lucide:arrow-right" class="h-5 w-5 group-hover:translate-x-1 transition-transform duration-300" />
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <!-- Statistics Section -->
    <section class="py-24 bg-gradient-to-br from-white via-gray-50 to-red-50 dark:from-gray-800 dark:via-gray-900 dark:to-red-950">
      <div class="max-w-7xl mx-auto px-6">
        ...
        <div v-if="pending && !data" class="flex justify-center py-16">
          <div class="text-center">
            <div class="w-16 h-16 bg-gradient-to-r from-red-500 to-red-600 rounded-full flex items-center justify-center mb-6 animate-bounce">
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div v-for="(stat, index) in stats" :key="stat.label" 
            ...
            <div class="bg-white dark:bg-gray-800 p-10 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 dark:border-gray-700 hover:border-red-200 dark:hover:border-red-600 transform hover:-translate-y-3 relative overflow-hidden">
              
              <!-- Background Gradient -->
              <div class="absolute inset-0 bg-gradient-to-br from-red-50 via-transparent to-transparent dark:from-red-950/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              
              <div class="relative text-center">
                <!-- Icon with Premium Design -->
                <div class="inline-flex items-center justify-center w-24 h-24 rounded-2xl mb-8 bg-gradient-to-br from-red-500 to-red-600 shadow-xl group-hover:shadow-2xl transition-all duration-500 group-hover:scale-110">
                  <Icon :name="stat.icon" class="h-12 w-12 text-white" />
                </div>
                
                <!-- Big Number with Animation -->
                <div class="text-5xl md:text-6xl font-black mb-4 bg-gradient-to-r from-red-600 via-red-700 to-red-800 bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-500">
                  {{ stat.value }}
                </div>
                
                <!-- Label with Style -->
                <div class="text-xl font-bold text-gray-700 dark:text-gray-300 group-hover:text-red-600 dark:group-hover:text-red-400 transition-colors duration-300">
                  {{ stat.label }}
                </div>  
              </div>
            </div>
        ...
        <div class="text-center mt-20">
          <div class="inline-flex items-center bg-white dark:bg-gray-800 px-8 py-4 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
