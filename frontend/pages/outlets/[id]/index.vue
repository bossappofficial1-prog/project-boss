        ...
        <div class="max-w-4xl mx-auto px-6">
                ...
                <div class="p-5">
                  ...
                  <div class="flex justify-between items-end">
                    ...
                    <div v-else class="flex items-center gap-2 bg-gray-100 dark:bg-gray-700 rounded-lg p-1">
                      <button
                        @click="cartStore.updateQuantity(product.id, getProductQuantityInCart(product.id) - 1)"
          ...
          <div v-if="activeTab === 'layanan'">
            <div v-if="!services.length" class="text-center py-20">
              <div class="w-20 h-20 bg-red-100 dark:bg-red-900/20 rounded-2xl flex items-center justify-center mx-auto mb-6">
                  ...
                  <div class="flex justify-between items-start">
                    ...
                    <div class="ml-6">
                      <div :class="[
                        ...
                        <Icon 
                          :name="selectedService?.id === service.id ? 'lucide:calendar-check' : 'lucide:calendar'" 
                          class="h-6 w-6" 
                        />
                      </div>
                    </div>
                ...
                <Transition name="expand">
                  <div v-if="selectedService?.id === service.id" class="border-t border-gray-200 dark:border-gray-700">
                    <div class="p-6 bg-red-50 dark:bg-red-900/10">
                      ...
                      <!-- Calendar -->
                      <div class="bg-white dark:bg-gray-800 rounded-xl shadow border border-gray-200 dark:border-gray-600 mb-6">
                        <VCalendar 
                      ...
                      <div v-if="isLoadingSlots" class="text-center py-8">
                        <div class="w-12 h-12 bg-red-600 rounded-full flex items-center justify-center mx-auto animate-pulse mb-4">
