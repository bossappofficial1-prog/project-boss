    ...
    <aside
        ...
        <div class="flex flex-col h-full">
            ...
            <div class="p-4 border-b border-primary-500/30">
                ...
                <BaseSelect v-model="selectedOutletId" :options="outletOptions" placeholder="Pilih Outlet"
                    value-key="id" label-key="name" class="bg-primary-700/50 border-primary-500" />
            </div>
            ...
            <div class="p-4 border-t border-primary-500/30 space-y-3">
                <div class="relative flex items-center space-x-3 p-3 bg-primary-700/30 rounded-lg cursor-pointer">
                    <div v-if="showProfileMenu"
                        class="absolute top-[-50%] w-full left-0 bg-primary-600 shadow-lg rounded-lg overflow-hidden z-50">
                        <div class="flex flex-col divide-y divide-gray-200 dark:divide-gray-700">
                            <BaseLogout class="text-white" />
                        </div>
                    </div>
                    <div class="flex flex-row gap-3" @click="toggleProfileMenu">
