...
> = ({
  ...
  dynamicTransactionFee,
  dynamicApplicationFee,
  dynamicGrandTotal,
  tableId,
  tableName,
  tableOutletId,
          ...
          <CardContent className="p-4 flex items-center gap-3">
            ...
            <div className="flex-1">
              <p className="text-[10px] font-bold text-primary uppercase tracking-wider mb-0.5">
                {t("orderSummary.diningOption")}
              </p>
              <h3 className="text-sm font-bold">
                {t("orderSummary.tableOrdering", {
                  tableId: tableName || tableId,
                })}
              </h3>
              <p className="text-[11px] text-muted-foreground">
                {t("orderSummary.tableOrderingDesc")}
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <CardContent className="pb-4 space-y-2">
          <div className="flex justify-between text-[13px]">
            <span className="text-muted-foreground">
              {t("orderSummary.totalOrder", { count: totalItems })}
            </span>
    ...
    () => [
      {
        ...
        description:
          "Pastikan subtotal dan detail outlet sudah sesuai sebelum memilih metode pembayaran.",
      ...
      },
      {
        ...
        description:
          "Bandingkan metode yang tersedia lalu pilih yang paling cocok untuk transaksi kamu.",
      ...
      },
      {
        ...
        title: "Buat order",
        description:
          "Setelah metode dipilih, tekan tombol ini untuk melanjutkan ke proses pembayaran.",
        ...
        <CardContent className="p-4">
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-3 gap-2 text-[11px] sm:text-xs">
              <div className="rounded-md border bg-muted/30 px-2 py-1.5 text-center font-medium">
                {t("stepper.summary")}
              </div>
              <div className="rounded-md border bg-primary/10 px-2 py-1.5 text-center font-semibold text-primary">
                {t("stepper.checkout")}
              </div>
              <div className="rounded-md border bg-muted/30 px-2 py-1.5 text-center font-medium">
                {t("stepper.payment")}
