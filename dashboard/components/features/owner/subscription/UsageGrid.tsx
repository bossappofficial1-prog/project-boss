                ...
                return (
                    ...
                    >
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
                            ...
                            <div className={cn(
                                "p-2.5 rounded-md transition-colors duration-300 bg-muted text-muted-foreground group-hover:bg-foreground group-hover:text-background border border-border/40"
                            )}>
                        ...
                        <CardContent className="pt-0">
                            ...
                            {limit === -1 ? (
                                <div className="mt-4 flex items-center gap-2 px-3 py-2 rounded-md bg-emerald-500/10 border border-emerald-500/20 w-fit">
                                    ...
                                    <span className="text-[10px] font-black uppercase tracking-widest text-emerald-600">Tanpa Batas</span>
                                </div>
                            ) : (
                                <div className="mt-4 space-y-2">
                                    <div className="flex items-center justify-between text-[9px] font-black uppercase tracking-tighter mb-1">
                                        <span className="text-muted-foreground">Pemanfaatan Kuota</span>
                                        <span className={cn(
                                            isHighUsage ? "text-rose-600" : isMediumUsage ? "text-amber-600" : "text-foreground"
                                        )}>
                                            {percentage}%
                                        </span>
                                    </div>
                                    <div className="relative h-2 w-full overflow-hidden rounded-full bg-muted shadow-none">
                                        <div
                                            className={cn(
                                                ...
                                                isHighUsage ? "bg-rose-500" : isMediumUsage ? "bg-amber-500" : "bg-foreground"
                                            )}
                                    ...
                                    <div className="flex items-center justify-between text-[10px] font-bold mt-2">
                                        <div className="flex items-center gap-1 text-muted-foreground">
                                            ...
                                            <span>Sisa: <span className="text-foreground">{remaining ?? 0}</span></span>
                                        </div>
