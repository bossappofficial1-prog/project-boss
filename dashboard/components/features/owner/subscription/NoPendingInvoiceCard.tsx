                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-1">
                        <div className="flex items-center gap-2">
                            <p className="text-lg font-black tracking-tight text-foreground">Status Pembayaran Aman</p>
                            <Sparkles className="h-4 w-4 text-emerald-500" />
                        </div>
                        <p className="text-sm text-muted-foreground font-medium">
                            Semua tagihan telah diselesaikan. Paket Anda aktif sepenuhnya tanpa kendala administrasi.
                        </p>
                    </div>
                </div>
                <Button
                    variant="outline"
                    className="w-full md:w-auto h-11 px-6 gap-2 font-black uppercase tracking-widest text-[10px] border-emerald-500/30 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-500/10 shadow-none transition-all active:scale-95"
                    onClick={onRenew}
                    disabled={disabled}
                >
