    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
            <div className="space-y-2 text-center lg:text-left">
                <h2 className="text-3xl font-bold text-slate-900 tracking-tight">Buat Akun</h2>
                <p className="text-slate-500">Mulai perjalanan bisnis Anda bersama BOSS.</p>
            </div>
            ...
            <div className="space-y-5">
                ...
                <p className="text-center text-sm text-slate-500">
                    Sudah punya akun?{' '}
                    <Link href="/auth/login" className="font-bold text-red-600 hover:text-red-700 hover:underline">
                        Masuk
                    </Link>
                </p>
            </div>
