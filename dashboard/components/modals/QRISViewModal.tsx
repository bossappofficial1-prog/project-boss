...
interface QRISViewModalProps {
  ...
  showActions?: boolean; // Apakah menampilkan tombol upload/hapus
  onQRISUpdate?: () => void;
}
          ...
          {isLoading ? (
            <div className="flex items-center justify-center py-12">
              <div className="text-center space-y-4">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Memuat QRIS...</p>
              </div>
            </div>
            ...
            <>
              ...
              <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                <div className="relative w-full max-w-[400px] mx-auto aspect-square bg-white rounded-lg shadow-lg p-4">
