...
export default function Header({ onToggleSidebar }: HeaderProps) {
  ...
  return (
    <header className="bg-white/80 backdrop-blur-lg shadow-lg border-b border-red-100 sticky top-0 z-30">
        ...
        <div className="flex justify-between items-center py-3 sm:py-4">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            <button
              ...
              className="lg:hidden p-2 sm:p-3 rounded-xl text-red-500 hover:text-red-600 hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-red-500/20 transition-all duration-200"
            >
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="hidden sm:block text-left">
                  ...
                  <p className="text-xs text-red-600 font-medium font-poppins">
                    {user?.role || 'Owner'}
                  </p>
                </div>
                <svg
              ...
              {/* Dropdown menu */}
              {isDropdownOpen && (
                <div className="absolute right-0 mt-2 w-48 sm:w-56 bg-white rounded-2xl shadow-2xl border border-gray-100 py-2 z-50 animate-in slide-in-from-top-5 duration-200">
                  ...
                  <button
                    ...
                    className="w-full text-left px-3 sm:px-4 py-2 sm:py-3 text-sm text-gray-700 hover:bg-red-50 hover:text-red-700 flex items-center font-poppins transition-colors duration-150"
                  >
                  ...
                  <div className="border-t border-gray-100 mt-2">
                    <button
                      ...
                      className="w-full text-left px-3 sm:px-4 py-2 sm:py-3 text-sm text-red-600 hover:bg-red-50 flex items-center font-poppins transition-colors duration-150"
                    >
