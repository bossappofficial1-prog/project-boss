...
export default function MobileCard({ product, onEdit, onDelete, onToggleStatus, formatDuration }: MobileCardsProps) {
  return (
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="mt-2 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => onDelete(product)} className="text-red-600 hover:text-red-900 p-1" title="Hapus">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
