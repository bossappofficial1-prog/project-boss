...
export default function StockMobileCards({ item, onUpdateStock, formatCurrency, getStockStatus, getStockStatusColor }: Props) {
  return (
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="mt-2 flex items-center justify-between text-sm text-gray-700 dark:text-gray-300">
            ...
            <Button
              ...
              className="h-auto px-0 text-indigo-600 hover:text-indigo-900"
            >
              Update Stok
            </Button>
          </div>
