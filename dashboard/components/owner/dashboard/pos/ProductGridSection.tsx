                    ...
                    <>
                        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
                            {paginatedProducts.map((product) => {
                                ...
                                const isOutOfStock = product.type === 'GOODS' && (product.quantity ?? 0) <= 0;
                                    ...
                                    >
                                        <CardContent className="space-y-2 p-4">
                                                ...
                                                {productImage ? (
                                                    <Image
                                                        ...
                                                        onError={(event) => {
                                                            ...
                                                            target.src = 'https://png.pngtree.com/png-vector/20230808/ourmid/pngtree-goods-and-services-vector-png-image_6891390.png';
                                                        }}
                                                    />
                                                ) : (
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                {product.type === 'GOODS' ? (
                                                    <p className="text-xs text-slate-600 dark:text-slate-400">Stok: {product.quantity ?? 0}</p>
                                                ) : (
                                                    <p className="text-xs text-slate-600 dark:text-slate-400">
                                                        Durasi ± {product.serviceDurationMinutes ?? 0} menit
                                                    </p>
                                                )}
