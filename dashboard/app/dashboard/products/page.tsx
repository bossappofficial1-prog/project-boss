      ...
      <div className="space-y-8">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <button
            ...
            className="flex items-center justify-center px-6 py-3 bg-red-gradient text-white rounded-lg hover:shadow-lg transition-all duration-300"
          >
          ...
          <button
            ...
            className="flex items-center justify-center px-6 py-3 bg-green-gradient text-white rounded-lg hover:shadow-lg transition-all duration-300"
          >
            <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          {products.length === 0 && !isLoading && (
            <div className="text-center py-12">
              ...
              <button
                onClick={() => setShowAddModal(true)}
                className="inline-flex items-center px-4 py-2 bg-red-gradient text-white rounded-lg hover:shadow-lg transition-all duration-300"
              >
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                </svg>
