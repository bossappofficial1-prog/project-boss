        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-red-50 via-rose-50 to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center px-4 sm:px-6 lg:px-8">
                <div className="text-center">
                    ...
                    <p className="mt-4 text-gray-600 dark:text-gray-400">Memverifikasi token...</p>
                </div>
            </div>
        );
    }
                            ...
                            <>
                                ...
                                {formData.password && (
                                    <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-3 border border-gray-200 dark:border-gray-600">
                                        <p className="text-xs font-medium text-gray-600 dark:text-gray-400 mb-2 font-poppins">Password Requirements:</p>
                                        <div className="space-y-1">
                                            {passwordStrength.map((req, index) => (
                                                <div key={index} className="flex items-center text-xs font-poppins">
                                                    <div className={`w-3 h-3 rounded-full mr-2 flex-shrink-0 ${req.met ? 'bg-green-500' : 'bg-gray-300 dark:bg-gray-600'}`}>
                                                        {req.met && (
