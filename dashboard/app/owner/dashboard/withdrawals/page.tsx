    ...
    <>
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 font-poppins">Penarikan Dana</h1>
            <p className="mt-1 text-sm text-gray-500 font-poppins">
              Kelola penarikan dana dari hasil penjualan
            </p>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 min-h-96">
          <div className="flex items-center justify-center h-96">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2 font-poppins">Halaman Penarikan Dana</h3>
              <p className="text-gray-600 font-poppins mb-4">
                Konten untuk penarikan dana akan diimplementasikan di sini.
              </p>
              <p className="text-sm text-gray-400 font-poppins">
                Fitur: Withdrawal calculation, bank account, withdrawal history, approval status, dll.
              </p>
            </div>
          </div>
        </div>
