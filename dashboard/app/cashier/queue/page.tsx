...
export default function CashierQueuePage() {
  ...
  const handleQueueSnapshot = useCallback(
    ...
    queueData?.filter((item) => {
      ...
      const matchesStatus =
        ...
        (statusFilter === "pending" &&
          ["AWAITING_PAYMENT", "CONFIRMED", "PROCESSING"].includes(item.status as string)) ||
  ...
  return (
    <div className="mx-auto max-w-[1500px] p-4 space-y-6">
      <QueueHeader onRefresh={handleRefresh} onCreateQuick={() => router.push("/cashier/pos")} />
