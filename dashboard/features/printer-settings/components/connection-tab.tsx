...
import { usePrinterStore, type PrinterState } from "@/stores/printer.store";
            ...
            {hasSaved && (
                <div>
                    ...
                    <div className="flex flex-col gap-2">
                        {printer.savedBtDevices.map((d: BluetoothDevice, i: number) => (
                            <DeviceRow
                                key={`bt-${i}`}
                        ...
                        {printer.savedUsbDevices.map((d: USBDevice, i: number) => (
                            <DeviceRow
                                key={`usb-${i}`}
