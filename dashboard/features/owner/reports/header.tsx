...
export function ReportsHeader({ onRefresh }: ReportsHeaderProps) {
	return (
		<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
			<div>
				<h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Laporan Harian</h1>
				<p className="text-gray-600 dark:text-gray-400 mt-1">Ringkasan transaksi harian per outlet</p>
			</div>
