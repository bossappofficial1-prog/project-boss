      ...
      >
        ...
        >
          {[
            {
              label: "Pesanan Saya",
              icon: <Package color={c.mutedForeground} />,
              route: "/(tabs)/cart",
            },
            {
              label: "Favorit",
              icon: <Heart color={c.mutedForeground} />,
              route: "/(tabs)/cart",
            },
            {
              label: "Terdekat",
              icon: <MapPin color={c.mutedForeground} />,
              route: "/(tabs)/products",
            },
          ].map((action) => (
            <Pressable
              ...
              style={{
                ...
                paddingVertical: 12,
                borderRadius: 12,
                backgroundColor: c.quickAction.bg,
              }}
            >
          ...
          >
            ...
            <View style={{ marginHorizontal: 0 }}>
              {data.popularItems.slice(0, 8).map((item, index) => (
                <View key={item.id}>
                  <ProductCard item={item} rank={index + 1} />
