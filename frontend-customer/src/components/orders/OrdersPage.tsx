...
const EnhancedOrderCard = dynamic<
    import("./parts/EnhancedOrderCard").EnhancedOrderCardProps
                ...
                switch (action) {
                    ...
                    case "reorder": {
                        ...
                        for (const item of order.items) {
                            ...
                            if (!addItem(order.outletId, order.outlet.name, detail, item.quantity)) {
        ...
        <div className="space-y-3">
            ...
            {hasOrders && filteredOrders.length > 0 && (
                <p className="text-xs text-muted-foreground px-1">
                    ...
                    {filteredOrders.length === 1 ? t("order_singular") : t("order_plural")}{" "}
                    {t("found")}
                </p>
            )}
