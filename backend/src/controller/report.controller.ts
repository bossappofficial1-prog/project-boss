...
export const getOutletReportController = asyncHandler(
  async (req: Request, res: Response) => {
...
export const getStaffReportController = asyncHandler(
  async (req: Request, res: Response) => {
    const outletId = req.params.outletId as string;
    const { type, date } = req.query;
    const ownerId = req.storedUser?.id;
...
export const exportTransactionReportController = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    return ResponseUtil.success(
      ...
      null,
      HttpStatus.OK,
      "E-statement sedang diproses. Akan dikirim ke email Anda.",
    );
  },
);
...
export const exportOutletReportExcelController = asyncHandler(
  async (req: Request, res: Response) => {
    const outletId = req.params.outletId as string;
...
export const exportStaffReportExcelController = asyncHandler(
  async (req: Request, res: Response) => {
    const outletId = req.params.outletId as string;
