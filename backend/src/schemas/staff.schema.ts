...
export const createStaffSchema = z.object({
  ...
  phone: nullableString(
    z.string().min(6, "Nomor telepon tidak valid").max(32, "Nomor telepon terlalu panjang"),
  ),
  ...
  password: nullableString(
    z.string().min(6, "Password minimal 6 karakter").max(100, "Password maksimal 100 karakter"),
  ),
});
