...
import { ProductMediaRepository, CreateMediaInput } from "../repositories/product-media.repository";
...
export class ProductMediaService {
     ...
     */
    static async syncMedia(productId: string, mediaItems: MediaItemInput[]): Promise<void> {
    ...
    /**
     * Validate embed URL (YouTube/TikTok) and return normalized embed URL.
     */
    static validateEmbedUrl(url: string): { valid: boolean; embedUrl: string; thumbnailUrl?: string } {
        // YouTube
