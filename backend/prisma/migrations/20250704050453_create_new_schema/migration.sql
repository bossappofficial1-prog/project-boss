...
-- CreateEnum
CREATE TYPE "OrderPaymentStatus" AS ENUM ('AUTHORIZE', 'CAPTURE', 'SETTLEMENT', 'DENY', 'PENDING', 'CANCEL', 'REFUND', 'PARTIAL_REFUND', 'CHARGEBACK', 'PARTIAL_CHARGEBACK', 'EXPIRE', 'FAILURE');
...
-- CreateEnum
CREATE TYPE "CustomerType" AS ENUM ('REGISTERED', 'GUEST');
...
CREATE TABLE "Order" (
    ...
    "queueStatus" "OrderQueueStatus" NOT NULL DEFAULT 'AWAITING_PAYMENT',
    "midtransTransactionToken" TEXT,
    "midtransRedirectUrl" TEXT,
    "midtransTransactionDetails" JSONB,
    "customerId" TEXT,
