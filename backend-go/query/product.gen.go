...
func newProduct(db *gorm.DB, opts ...gen.DOOption) product {
	...
	_product.OutletID = field.NewString(tableName, "outletId")
	_product.Image = field.NewString(tableName, "image")
	_product.CreatedAt = field.NewTime(tableName, "createdAt")
	_product.UpdatedAt = field.NewTime(tableName, "updatedAt")
...
func (p *product) updateTableName(table string) *product {
	...
	p.OutletID = field.NewString(table, "outletId")
...
func (p *product) fillFieldMap() {
	...
	p.fieldMap["outletId"] = p.OutletID
