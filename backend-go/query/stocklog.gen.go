...
func newStockLog(db *gorm.DB, opts ...gen.DOOption) stockLog {
	...
	_stockLog.Type = field.NewString(tableName, "type")
	_stockLog.Quantity = field.NewInt32(tableName, "quantity")
	_stockLog.HppPerUnit = field.NewFloat64(tableName, "hppPerUnit")
	_stockLog.ReferenceType = field.NewString(tableName, "referenceType")
	_stockLog.ReferenceID = field.NewString(tableName, "referenceId")
	_stockLog.Notes = field.NewString(tableName, "notes")
	_stockLog.ProductGoodsID = field.NewString(tableName, "productGoodsId")
	_stockLog.CreatedAt = field.NewTime(tableName, "createdAt")
	_stockLog.Faktur = field.NewString(tableName, "faktur")
...
type stockLog struct {
	...
	HppPerUnit     field.Float64
	ReferenceType  field.String
	ReferenceID    field.String
	Notes          field.String
	ProductGoodsID field.String
...
func (s *stockLog) updateTableName(table string) *stockLog {
	...
	s.HppPerUnit = field.NewFloat64(table, "hppPerUnit")
	s.ReferenceType = field.NewString(table, "referenceType")
	s.ReferenceID = field.NewString(table, "referenceId")
	s.Notes = field.NewString(table, "notes")
	s.ProductGoodsID = field.NewString(table, "productGoodsId")
	s.CreatedAt = field.NewTime(table, "createdAt")
	s.Faktur = field.NewString(table, "faktur")
...
func (s *stockLog) fillFieldMap() {
	...
	s.fieldMap["hppPerUnit"] = s.HppPerUnit
	s.fieldMap["referenceType"] = s.ReferenceType
	s.fieldMap["referenceId"] = s.ReferenceID
	s.fieldMap["notes"] = s.Notes
	s.fieldMap["productGoodsId"] = s.ProductGoodsID
	s.fieldMap["createdAt"] = s.CreatedAt
	s.fieldMap["faktur"] = s.Faktur
}
