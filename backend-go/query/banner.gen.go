...
func newBanner(db *gorm.DB, opts ...gen.DOOption) banner {
	...
	_banner.ImageURL = field.NewString(tableName, "imageUrl")
	_banner.CtaType = field.NewString(tableName, "ctaType")
	_banner.CtaPayload = field.NewString(tableName, "ctaPayload")
	_banner.SortOrder = field.NewInt32(tableName, "sortOrder")
	_banner.IsActive = field.NewBool(tableName, "isActive")
	_banner.BusinessID = field.NewString(tableName, "businessId")
	_banner.CreatedAt = field.NewTime(tableName, "createdAt")
	_banner.UpdatedAt = field.NewTime(tableName, "updatedAt")
...
func (b *banner) updateTableName(table string) *banner {
	...
	b.ImageURL = field.NewString(table, "imageUrl")
	b.CtaType = field.NewString(table, "ctaType")
	b.CtaPayload = field.NewString(table, "ctaPayload")
	b.SortOrder = field.NewInt32(table, "sortOrder")
	b.IsActive = field.NewBool(table, "isActive")
...
func (b *banner) fillFieldMap() {
	...
	b.fieldMap["imageUrl"] = b.ImageURL
	b.fieldMap["ctaType"] = b.CtaType
	b.fieldMap["ctaPayload"] = b.CtaPayload
	b.fieldMap["sortOrder"] = b.SortOrder
	b.fieldMap["isActive"] = b.IsActive
