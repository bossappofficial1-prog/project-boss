...
func newOrder(db *gorm.DB, opts ...gen.DOOption) order {
	...
	_order.BookingDate = field.NewTime(tableName, "bookingDate")
	_order.CustomerType = field.NewString(tableName, "customerType")
	_order.PaymentStatus = field.NewString(tableName, "paymentStatus")
	_order.PaymentReminderSent = field.NewBool(tableName, "paymentReminderSent")
	_order.OrderStatus = field.NewString(tableName, "orderStatus")
	_order.MidtransTransactionToken = field.NewString(tableName, "midtransTransactionToken")
	_order.MidtransRedirectURL = field.NewString(tableName, "midtransRedirectUrl")
	_order.MidtransFee = field.NewFloat64(tableName, "midtransFee")
	_order.AppFee = field.NewFloat64(tableName, "appFee")
	_order.GuestCustomerID = field.NewString(tableName, "guestCustomerId")
	_order.OutletID = field.NewString(tableName, "outletId")
	_order.HandledByStaffID = field.NewString(tableName, "handledByStaffId")
	_order.CreatedAt = field.NewTime(tableName, "createdAt")
	_order.UpdatedAt = field.NewTime(tableName, "updatedAt")
	_order.CancellationReason = field.NewString(tableName, "cancellationReason")
...
type order struct {
	...
	BookingDate              field.Time
	CustomerType             field.String
	PaymentStatus            field.String
	PaymentReminderSent      field.Bool
	OrderStatus              field.String
	MidtransTransactionToken field.String
	MidtransRedirectURL      field.String
	MidtransFee              field.Float64
	AppFee                   field.Float64
	GuestCustomerID          field.String
	OutletID                 field.String
	HandledByStaffID         field.String
	CreatedAt                field.Time
	UpdatedAt                field.Time
	CancellationReason       field.String
...
func (o *order) updateTableName(table string) *order {
	...
	o.BookingDate = field.NewTime(table, "bookingDate")
	o.CustomerType = field.NewString(table, "customerType")
	o.PaymentStatus = field.NewString(table, "paymentStatus")
	o.PaymentReminderSent = field.NewBool(table, "paymentReminderSent")
	o.OrderStatus = field.NewString(table, "orderStatus")
	o.MidtransTransactionToken = field.NewString(table, "midtransTransactionToken")
	o.MidtransRedirectURL = field.NewString(table, "midtransRedirectUrl")
	o.MidtransFee = field.NewFloat64(table, "midtransFee")
	o.AppFee = field.NewFloat64(table, "appFee")
	o.GuestCustomerID = field.NewString(table, "guestCustomerId")
	o.OutletID = field.NewString(table, "outletId")
	o.HandledByStaffID = field.NewString(table, "handledByStaffId")
	o.CreatedAt = field.NewTime(table, "createdAt")
	o.UpdatedAt = field.NewTime(table, "updatedAt")
	o.CancellationReason = field.NewString(table, "cancellationReason")
...
func (o *order) fillFieldMap() {
	...
	o.fieldMap["bookingDate"] = o.BookingDate
	o.fieldMap["customerType"] = o.CustomerType
	o.fieldMap["paymentStatus"] = o.PaymentStatus
	o.fieldMap["paymentReminderSent"] = o.PaymentReminderSent
	o.fieldMap["orderStatus"] = o.OrderStatus
	o.fieldMap["midtransTransactionToken"] = o.MidtransTransactionToken
	o.fieldMap["midtransRedirectUrl"] = o.MidtransRedirectURL
	o.fieldMap["midtransFee"] = o.MidtransFee
	o.fieldMap["appFee"] = o.AppFee
	o.fieldMap["guestCustomerId"] = o.GuestCustomerID
	o.fieldMap["outletId"] = o.OutletID
	o.fieldMap["handledByStaffId"] = o.HandledByStaffID
	o.fieldMap["createdAt"] = o.CreatedAt
	o.fieldMap["updatedAt"] = o.UpdatedAt
	o.fieldMap["cancellationReason"] = o.CancellationReason
}
