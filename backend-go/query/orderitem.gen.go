...
func newOrderItem(db *gorm.DB, opts ...gen.DOOption) orderItem {
	...
	_orderItem.PriceAtTimeOfOrder = field.NewFloat64(tableName, "priceAtTimeOfOrder")
	_orderItem.OrderID = field.NewString(tableName, "orderId")
	_orderItem.ProductID = field.NewString(tableName, "productId")
...
type orderItem struct {
	...
	PriceAtTimeOfOrder field.Float64
...
func (o *orderItem) updateTableName(table string) *orderItem {
	...
	o.PriceAtTimeOfOrder = field.NewFloat64(table, "priceAtTimeOfOrder")
	o.OrderID = field.NewString(table, "orderId")
	o.ProductID = field.NewString(table, "productId")
...
func (o *orderItem) fillFieldMap() {
	...
	o.fieldMap["priceAtTimeOfOrder"] = o.PriceAtTimeOfOrder
